...
export default function NurseListView({ nurseScheduleData }) {
    ...
    if (!nurseScheduleData || nurseScheduleData.length === 0) {
        console.log('Nurse schedule data is empty or undefined:', nurseScheduleData);
        ...
        <div className="overflow-x-auto">
            <div className="mx-auto bg-white rounded-lg">
                <table className="min-w-full bg-white rounded-lg">
                    ...
                    <tbody>
                        {nurseScheduleData.map((data, index) => (
                            <tr key={data.patientId}>
                                <td className="px-8 py-4 whitespace-nowrap">
                                    <div className="text-base font-semibold text-gray-900">{data.patientName}</div>
                                </td>
