...
const PatientValueGraph = ({ className }) => {
  const series = [{
    name: 'Daily Patient Volumes',
    data: [65, 68, 66, 70, 75, 78, 80] // Example data points
  }];
  ...
  return (
    <Box className={`${className} h-full`} p={4} borderWidth={1} borderRadius="lg" boxShadow="md" bg="white">
      <Text fontSize="lg" fontWeight="bold" mb={2}>Daily Patient Volumes</Text>
      <Flex justify="space-between" align="center" mb={2}>
        <Box textAlign="center">
          <Text fontSize="md" fontWeight="bold">80</Text>
        ...
        <Box textAlign="center">
          <Text fontSize="md" fontWeight="bold">68</Text>
...
export default PatientValueGraph;